...
function Aliki() {
  return (
    <div id="Aliki">
      ...
      <div className="mobile text-justify flex flex-col gap-8 mb-8 md:hidden">
        <p>
      ...
      <div className="desktop text-justify hidden md:block">
        <div className="grid grid-cols-2 flex-col gap-8 mb-8">
          <div className="col-span-1 flex flex-col gap-8">
            ...
            <p>
              ...
              υπάρχει πάντα και παντού. Είτε στην παραδοσιακή μορφή του, είτε σε
              μορφή e-book, είτε από την οθόνη του κινητού και του υπολογιστή.
              Καθένα, με τα θετικά και τα αρνητικά του βέβαια, μπορεί να
        ...
        <div className="below-grid flex flex-col gap-8">
          ...
          <p className="3xl:hidden">
            ...
            και στην πιο μικρή μου τσάντα. Πλέον, όπου και να βρίσκομαι μπορώ αν
            θέλω να χαθώ μέσα στα βιβλία μου.
          </p>
        </div>
      </div>
