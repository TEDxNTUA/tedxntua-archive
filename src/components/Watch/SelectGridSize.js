...
const SelectGridSize = ({ gridSizeXl, setGridSizeXl }) => {
  return (
    ...
    <div className="hidden lg:flex lg:flex-col items-center w-[7vw] justify-center border gap-2  border-white rounded-md fixed bottom-[50%] p-1">
      {/* <p className="text-white text-base font-bold  italic underline decoration-our-red underline-offset-4"> */}
      <p className="text-white text-xs font-bold  text-center italic underline decoration-our-red underline-offset-4">
      ...
      <div className="grid grid-cols-1">
        <button
          className={`text-white text-base font-bold cursor-pointer border-black border rounded-md px-3 mx-1 ${
            gridSizeXl === 3 ? "bg-our-red text-white" : ""
          }`}
        ...
        <button
          className={`text-white text-base font-bold cursor-pointer border-black border rounded-md px-3 mx-1 ${
            gridSizeXl === 4 ? "bg-our-red text-white" : ""
          }`}
