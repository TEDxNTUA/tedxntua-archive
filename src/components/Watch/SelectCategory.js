...
const SelectCategory = ({ category, setCategory, uniqueCategories }) => {
  ...
  return (
    ...
    //   </div>
    // </div>
    <div className="flex flex-col gap-2 p-1 border border-white rounded-md text-white">
      <p className="title font-bold italic underline decoration-our-red underline-offset-4 text-xl text-center">
        Category
      </p>
