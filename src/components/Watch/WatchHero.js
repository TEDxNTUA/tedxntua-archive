...
const WatchHero = ({
  ...
  return (
    <div className="flex flex-col items-center lg:relative justify-center lg:mt-[100px] lg:mb-[8%] lg:z-[2] lg:bg-black">
      ...
      <div className="grid grid-cols-2 justify-end items-start gap-[2vw] w-auto ml-[60%] mt-[2%]">
        <DropdownCategory
          category={category}
